...
<figure>
  <img src="assets/fail_examples/rag_hallucination_fail.png" width="40%" alt="Пример галлюцинации цены и вывода технических метаданных">
...
<h3>Визуальный результат оптимизации:</h3>

<figure>
  <img src="assets/success_examples/rag_smart_calc_success.png" width="40%" alt="Идеальный UX: автоматический расчет и отсутствие шум">
  <figcaption><i>Рис 2. Идеальный UX: автоматический расчет и отсутствие "шума".</i></figcaption>
</figure>
<br>
<figure>
  <img src="assets/success_examples/rag_safety_guard_success.png" width="40%" alt="Безопасный отказ при отсутствии данных в базе">
  <figcaption><i>Рис 3. Безопасный отказ при отсутствии данных в базе.</i></figcaption>
</figure>
